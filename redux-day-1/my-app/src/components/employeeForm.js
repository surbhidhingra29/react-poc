...
import { addUser } from "../redux-part/actions";
...
class EmpForm extends React.Component {
    ...
    render() {
        return (
            <>
                <div className="col-12 shadwo mx-auto border shadow p-3 round">
...
const AddUserForm = connect(null, mapDispatchToProps)(EmpForm);
